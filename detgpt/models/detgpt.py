...
from detgpt.models.blip2 import Blip2Base, disabled_train
...
@registry.register_model("detgpt")
class DetGPT(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_vicuna_7b": "configs/models/detgpt_7b.yaml",
        "pretrain_vicuna_13b": "configs/models/detgpt_13b.yaml",
        "pretrain_robin_7b": "configs/models/detgpt_robin_7b.yaml",
    }
    ...
    def forward(self, samples):
        ...
        elif "task" in samples:
            task = samples['task']
            if "description" in samples:
