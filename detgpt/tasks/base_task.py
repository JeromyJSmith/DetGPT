...
from detgpt.common.dist_utils import get_rank, get_world_size, is_main_process, is_dist_avail_and_initialized
from detgpt.common.logger import MetricLogger, SmoothedValue
from detgpt.common.registry import registry
from detgpt.datasets.data_utils import prepare_sample
